<template>
    ...
    <div
        ...
        <h2 style="margin-left: 5rem;">RE3546</h2>
    ...
    <div style="width: 100%;" class="container">
        <h3 style="text-align: center; margin: 0;">Informações</h3>
    </div>
        ...
        <div
            ...
            <div style="display: flex; justify-content: center; align-content: center;">
                ...
                <div style="text-align: center;width: 7rem; ">
                    ...
                    <select class="form-select" style="border-radius: 10px; border: 1px solid black; ">
                ...
                <div style="text-align: center;width: 25rem; margin-left: 1rem;">
                    <strong>
                        Nome
                    </strong>
                    <input type="text" class="form-control" value="Apresentação tela de protocolo" style="border: black 1px solid; border-radius: 10px;">
                </div>
                ...
                <div style="text-align: center;width: 9rem; margin-left: 1rem;">
                    <strong>
                        Data
                    </strong>
                    <input type="date" class="form-control" value="2024-01-25" style="border: black 1px solid; border-radius: 10px;">
                </div>

                <div style="text-align: center;width: 7rem; margin-left: 1rem;">
                    <strong>
                        Hora
                    </strong>
                    <input type="time" class="form-control" value="12:30" style="border: black 1px solid; border-radius: 10px;">
                </div>

            </div>

            <div class="d-flex mb-3"
                style="border: 1px solid black; margin-top: 1rem; padding: 5px; border-radius: 10px;">
                <div class="p-2">Anexos:</div>
                <div class="ms-auto p-2"><i style="font-size: 25px;" class="bi bi-plus-circle"></i></div>
            </div>

        </div>
    </div>

    <div style="width: 100%; padding-top: 0rem;" class="container">
        <h3 style="text-align: center; margin: 0;">Tarefas</h3>
    </div>
...
export default {
            ...
            this.sprints = [
    {
        ...
        "status": "Em andamento",
        "deleted_at": null,
        "created_at": "2024-04-08T11:14:50.000000Z",
        "updated_at": "2024-04-08T11:15:57.000000Z",
        "programa_id": null,
        "pcm_id": null,
        "tarefas": [{
                "id": 14,
                "planoAcao_id": 19,
                "codigo": "Tarefa - 1",
                "descricao": "Elaboras tela de protocolo",
                "HP": 0,
                "responsavel_id": 4,
                "status": "Concluído",
                "dtInicio": "2024-04-03",
                "dtFim": "2024-04-08",
                "dtInicioReal": null,
                "dtFimReal": "2024-04-08",
                "deleted_by": null,
                "deleted_at": null,
                "created_at": "2024-04-08T11:15:00.000000Z",
                "updated_at": "2024-04-09T12:05:06.000000Z",
